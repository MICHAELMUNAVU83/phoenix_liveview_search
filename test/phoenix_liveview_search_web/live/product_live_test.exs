defmodule PhoenixLiveviewSearchWeb.ProductLiveTest do
  use PhoenixLiveviewSearchWeb.ConnCase

  import Phoenix.LiveViewTest
  import PhoenixLiveviewSearch.ProductsFixtures

  @create_attrs %{name: "some name", price: 42, quantity: 42}
  @update_attrs %{name: "some updated name", price: 43, quantity: 43}

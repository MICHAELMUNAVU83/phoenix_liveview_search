defmodule PhoenixLiveviewSearch.BlogsTest do
  use PhoenixLiveviewSearch.DataCase

  alias PhoenixLiveviewSearch.Blogs

  describe "blogs" do
    alias PhoenixLiveviewSearch.Blogs.Blog

    import PhoenixLiveviewSearch.BlogsFixtures
